...
export const SellerResetPassword = () => {
    ...
    useEffect(() => {
        ...
        const checkSession = async () => {
            ...
            console.log('[SellerResetPassword] Session check:', session ? 'Active' : 'None');
        };
        checkSession();
    }, []);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            console.log('[SellerResetPassword] Updating password...');
            ...
            if (updateError) {
                console.error('[SellerResetPassword] Update error:', updateError);
                setError(updateError.message);
                setLoading(false);
                return;
            }

            console.log('[SellerResetPassword] Password updated successfully');
            setSuccess(true);

            // Redirect to login after 3 seconds
            setTimeout(() => {
                navigate('/seller/login?message=Password updated successfully! Please login with your new password.');
            }, 3000);
        } catch (err) {
            console.error('[SellerResetPassword] Unexpected error:', err);
                ...
                <CardContent>
                    {success ? (
                        <div className="text-center py-6">
                            ...
                            <Link to="/seller/login?message=Password updated successfully! Please login with your new password.">
