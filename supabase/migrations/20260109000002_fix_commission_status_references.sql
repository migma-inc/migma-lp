-- Migration: Fix remaining commission_status references in payment request functions
-- This ensures all functions are updated after commission_status column was removed

-- Update get_seller_available_balance to remove commission_status references
...
-- Update create_seller_payment_request to remove commission_status references
