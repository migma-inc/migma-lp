-- Migration: Remove 30 days frequency limit for payment requests
-- Sellers can now request payment as many times as they want (as long as they have available balance)

-- Update function: Get seller available balance
-- Remove the 30 days check - can_request is now always true if there's available balance
...
-- Update function: Create seller payment request
-- Remove the 30 days validation check
